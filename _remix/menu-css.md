...
Άσκηση: Τροποποιήστε το παράδειγμα ενσωματώνοντας στο υπάρχον μενού περιεχόμενο της επιλογής σας. Αντί για CSS, χρησιμοποιήστε τον Preprocessor SCSS.
 ...
 <p data-height="350" data-theme-id="17517" data-slug-hash="wvzWzWN" data-default-tab="result" data-user="p2018028" class='codepen'>See the Pen <a href='https://codepen.io/p2018028/pen/wvzWzWN'>Pure CSS Circle Menu</a> by p2018028 (<a href='https://codepen.io/p2018028'>@p2018028</a>) on <a href='https://codepen.io'>CodePen</a>.</p>
<script async src="//assets.codepen.io/assets/embed/ei.js"></script>
